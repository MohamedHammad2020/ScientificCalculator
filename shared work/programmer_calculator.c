...
void main() {
	...
	printf(" 4.Convert from binary to decimal \n");
	printf(" 5.Convert from octal to decimal \n");
	printf(" 6.Convert from hexadecimal to decimal \n");
	printf(" 7.Convert from hexadecimal to binary \n");
	printf(" 8.Convert from hexadecimal to octal \n");
	printf(" 9.Convert from binary to octal \n");
	printf(" 10.Convert from binary to hexadecimal \n");
	printf(" 11.Convert from octal to binary \n");
	printf(" 12.Convert from octal to hexadecimal \n");
	...
	fflush(stdin);
    scanf("%d", &n);
	     printf("%d in octal = %d in decimal", n, convertOctalToDecimal(n));
         printf("\n");
        break;
		
	case 6  :
	
	printf("plz enter hexadecimal number:   ");
	fflush(stdin);
    scanf("%d", &m);
	
	    	fflush(stdin);
	    HexaToDecimal(gets(&m) );
		printf("\n");
...
printf("plz enter hexadecimal number:   ");
	...
	fflush(stdin);
    scanf("%d", &n);
         printf("%d in binary = %d in octal", n, convertBinaryToOctal(n));
         printf("\n");
		  break;
	case 10  :
	printf("Enter a number: ");
	fflush(stdin);
    scanf("%d", &n);
		     printf("%d in binary = %lX in Hexadecimal ",n, convertBinaryTohexa(n));
	...
	fflush(stdin);
    scanf("%d", &n);
    printf("%d in octal = %d in binary", n, convertOctalToBinary(n));
         printf("\n");
		  break;
    case 12  :
	...
	fflush(stdin);
    scanf("%d", &n);
	   printf("%d in Octal = %s in Hexadecimal ",n, convertOctalTohexa(n));   
      printf("\n");
		  break;
    default :
